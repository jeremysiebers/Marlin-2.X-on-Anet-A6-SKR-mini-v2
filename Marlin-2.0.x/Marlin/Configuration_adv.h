...
//#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  -3.00, -5.00 } }
...
#define MECHANICAL_GANTRY_CALIBRATION
  ...
  #define GANTRY_CALIBRATION_FEEDRATE        1000     // Feedrate for correction move
  //#define GANTRY_CALIBRATION_TO_MIN                   // Enable to calibrate Z in the MIN direction

  //#define GANTRY_CALIBRATION_SAFE_POSITION  { -3.00, -5.00 } // Safe position for nozzle
  //#define GANTRY_CALIBRATION_XY_PARK_FEEDRATE 3000  // XY Park Feedrate - MMM
  //#define GANTRY_CALIBRATION_COMMANDS_PRE   "G28"
  #define GANTRY_CALIBRATION_COMMANDS_POST  "G0 Z50\nG28"     // G28 highly recommended to ensure an accurate position
#endif
